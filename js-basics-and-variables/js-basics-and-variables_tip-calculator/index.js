...
console.log(`The total Cost of the meal, which accumulates to ${totalCost} consists of the tip, which is ${tipAmount} and the price for the meal itself, which is ${mealCost}.`);